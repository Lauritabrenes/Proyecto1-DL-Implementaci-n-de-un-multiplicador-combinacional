...
def export_pdf(bits, numero1, numero2, binario1, binario2, r, pasos, config, decimal_a_binario, hexadecimal_a_binario):
...
##-------------------------------------------------------- funciones
def export_pdf( decimal_a_binario, hexadecimal_a_binario):
